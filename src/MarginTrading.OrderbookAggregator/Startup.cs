...
namespace MarginTrading.OrderbookAggregator
{
    public class Startup
    {
        ...
        public static string ServiceName => "MarginTradingOrderbookAggregator";
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            try
            {
                ...
                builder.RegisterModule(new OrderbookAggregatorModule(appSettings, Log));
                builder.RegisterModule(new OrderbookAggregatorExternalServicesModule(appSettings));
